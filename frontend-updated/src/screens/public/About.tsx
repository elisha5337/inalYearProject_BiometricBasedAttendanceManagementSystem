...
import fingerImg from "../../assets/fingerprint1.jpg";
import attendanceImg from "../../assets/automaticattendance.jpg";
import auditingImg from "../../assets/auditingAttendance.jpg";
import manualImg from "../../assets/manualattendance.jpg";

export default function AboutPage() {
  const systemCapabilities = [
    {
      title: "Fingerprint Biometrics",
      description: "Utilizes advanced biometric fingerprint scanning to ensure secure, unique identity verification for every staff encounter, preventing unauthorized access and identity fraud.",
      image: fingerImg,
      icon: FingerIcon
    },
    {
      title: "Automated Attendance",
      description: "Seamlessly logs presence through high-speed biometric recognition, eliminating manual input errors and streamlining the daily check-in process across the entire campus.",
      image: attendanceImg,
      icon: ClipboardCheck
    },
    {
      title: "System Auditing",
      description: "Maintains an immutable digital audit trail of all attendance logs and system events, providing 100% transparency and data integrity for institutional oversight.",
      image: auditingImg,
      icon: Search
    }
  ];
  ...
  const milestones = [
    { year: "2023", title: "Institutional Audit", desc: "Analysis of manual attendance bottlenecks at Hawassa University campus nodes." },
    { year: "2024", title: "Technical Blueprint", desc: "Engineering the core biometric engine tailored for large-scale campus staff dynamics." },
    { year: "2025", title: "Identity Validation", desc: "Phase 1 successful pilot deployment at the Hawassa University Main Gate." },
    { year: "2026", title: "Digital Sovereignty", desc: "Full migration from legacy paper logs to campus-wide biometric accountability." }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="absolute top-6 left-6 px-4 py-1.5 bg-white/90 backdrop-blur-md rounded-xl shadow-lg border border-surface-border">
                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-indigo-600">Legacy System</span>
              </div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black text-surface-text tracking-tighter uppercase italic leading-none">
                The <span className="text-indigo-600">Evolution</span> of Attendance
              </h2>
              <div className="h-1.5 w-20 bg-indigo-600 rounded-full" />
              <p className="text-surface-muted text-lg font-medium leading-relaxed">
                Before the introduction of BBEAMS, Hawassa University relied primarily on paper-based manual attendance logs. This legacy system was prone to human error, buddy-punching, and significant administrative delays in reporting and payroll processing.
              </p>
              <p className="text-surface-muted text-lg font-medium leading-relaxed">
                Our project represents a leap forward—replacing these fragile paper trails with an immutable, high-speed biometric ecosystem that ensures 100% accuracy and real-time oversight.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-surface-accent/30 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mb-20">
             <h2 className="text-4xl md:text-5xl font-black text-surface-text mb-6">SYSTEM <span className="text-indigo-600 italic">CORE</span></h2>
             <p className="text-surface-muted text-lg font-semibold italic">The technological foundation of the BBEAMS ecosystem.</p>
          </div>
            ...
            {systemCapabilities.map((cap, i) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <img src={cap.image} alt={cap.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                ...
                <div className="p-10">
                  <h3 className="text-2xl font-black text-surface-text mb-4 uppercase tracking-tighter italic">{cap.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-indigo-400 mb-4">Strategic Purpose</h3>
                <h2 className="text-4xl font-black italic uppercase tracking-tighter mb-8 group-hover:text-indigo-400 transition-colors">Our Mission</h2>
                <p className="text-slate-300 text-lg font-medium leading-relaxed">
                  To provide a <span className="text-white font-bold">secure, efficient, and reliable</span> biometric attendance system that enhances institutional accountability, reduces administrative overhead, and empowers staff through transparent digital workflows.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-surface-muted mb-4">Future Trajectory</h3>
                <h2 className="text-4xl font-black italic uppercase tracking-tighter mb-8 group-hover:text-indigo-600 transition-colors">Our Vision</h2>
                <p className="text-surface-muted text-lg font-medium leading-relaxed">
                  To become <span className="text-surface-text font-bold">Ethiopia's leading institutional</span> biometric identity management platform, setting the standard for accuracy, security, and user experience in higher education.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h3 className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-[0.5em] mb-4">Project Evolution</h3>
              <h2 className="text-5xl font-black tracking-tighter text-surface-text italic uppercase leading-none">Our Journey</h2>
            </div>
            <p className="text-surface-muted font-bold text-sm uppercase tracking-widest border-l-4 border-indigo-600 pl-6">Key milestones in the <br /> BBEAMS development cycle</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {milestones.map((milestone, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-black text-surface-text italic uppercase tracking-tighter mb-4">{milestone.title}</h3>
                <p className="text-surface-muted text-sm font-medium leading-relaxed">{milestone.desc}</p>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h3 className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-[0.5em] mb-4">Ethics & Engineering</h3>
            <h2 className="text-5xl font-black tracking-tighter text-surface-text italic uppercase leading-none mb-6">Our Core Values</h2>
            <p className="text-surface-muted text-lg font-medium max-w-2xl mx-auto italic">The principles that guide everything we do as an institution.</p>
          </div>
            ...
            {[
              ...
              >
                 ...
                 <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-black text-surface-text italic uppercase tracking-tighter mb-4">{value.title}</h3>
