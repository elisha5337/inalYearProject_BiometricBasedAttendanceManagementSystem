...
import { fetchAdminLeaveRequests, type AdminLeaveRequestRecord } from '../../lib/admin';
...
export default function LeaveManagement() {
  ...
  const handleExport = () => {
    ...
    const csvContent =
      ...
      ['Employee Name,Employee ID,Leave Type,Start Date,End Date,Status', ...csvRows].join('\n');
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Read-only view of all employee leave requests and approvals</p>
        </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 font-mono uppercase tracking-tighter">{request.employeeId}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
            ...
            <div className="p-6 space-y-6 flex-1 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-bold text-slate-900">{new Date(selectedRequest.startDate).toLocaleDateString()}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">End Date</p>
                  <p className="text-sm font-bold text-slate-900">{new Date(selectedRequest.endDate).toLocaleDateString()}</p>
                </div>
              </div>
